...
Psyduck同学，学习需要不断的突破，也需要不断的反馈和消化。这里是你专属的16周学习计划和记录页面，希望经过16周的努力，能够成长为一枚数据分析小高手！加油！
...
**本周小结：**
第一个项目已经在周六通过了，分析的是领英的数据，现在刚看完excel的课程，正在写分析问卷数据的项目，工作日实在没时间，这周去合肥出了个差，还拐了一趟老家，幸亏excel的东西不难，感觉还行。
...
**本周小结：**
通过了第二个问卷调查项目和第三个预测邮寄宣传册项目，正在看sql部分，看到了lesson2 sql join部分，准备多花点时间研究下sql(助教：快手系列！加油加油！）
